(exports.id = 145),
  ...
  (exports.modules = {
    ...
    824: (e, t, r) => {
      ...
      let g = (0, l.createDedupedByCallsiteServerErrorLoggerDev)(_),
                ...
                if (t[0] === f) {
                  if (
                    ...
                    if (((I = (t = I).parent), t.errored))
                      e = H((e = new j('rejected', null, t.value, u)));
                    else if (0 < t.deps) {
            ...
            if (a.done) $(e, Error('Connection closed.'));
              ...
              for (var f = e._rowTag, d = e._rowLength, p = e._buffer, y = i.length; u < y; ) {
                ...
                if (-1 < h)
                      ...
                      case 73:
                        ...
                        if (
                          ...
                          if (h) {
                            var g = h;
                            g.status = 'blocked';
                          } else (g = new j('blocked', null, null, f)), y.set(d, g);
                          p.then(
                            function () {
                              return F(g, m);
                            },
                        ...
                        } else h ? F(h, m) : y.set(d, new j('resolved_module', m, null, f));
                        break;
                      case 72:
                        switch (
                          ((t = n[0]),
                  ...
                  })(e, a, f, p, (d = new Uint8Array(i.buffer, m, h - u))),
                    (u = h),
                    3 === s && u++,
                    (d = a = f = s = 0),
                    (p.length = 0);
                else {
                  (i = new Uint8Array(i.buffer, m, i.byteLength - u)),
                    p.push(i),
                    (d -= i.byteLength);
                  break;
                }
    ...
    1307: (e, t, r) => {
      ...
      e.exports = n(
        'C:\\Users\\giuli\\Documents\\Solvd\\solvd-react-laba-2025\\homeworks\\22-nextjs-1\\avatar-app-2\\node_modules\\next\\dist\\client\\components\\render-from-template-context.js'
      );
    },
    1448: (e, t) => {
      'use strict';
    ...
    2706: (e, t, r) => {
      ...
      async function w(e, t, r, n, o, a, i, u, l) {
        let s,
          ...
          h = u(c),
          g = n;
        h && null !== h.value && (g = { ...n, [h.param]: h.value });
        let b = (0, m.createServerParamsForMetadata)(g, l);
...
${t}`
    ...
    8243: (e, t, r) => {
      ...
      function R(e) {
        ...
        let { tree: d } = l,
          ...
          m = 'object' == typeof h && null !== h && 'function' == typeof h.then ? (0, u.use)(h) : h;
        if (!m) {
          let e = n.lazyData;
          if (null === e) {
      ...
      function S(e) {
        ...
        let M = _[0],
          ...
          k = (0, g.createRouterCacheKey)(x),
          D = (0, g.createRouterCacheKey)(x, !0),
          C = j.get(k);
        if (void 0 === C) {
          let e = {
            lazyData: null,
          ...
          s.TemplateContext.Provider,
          {
            value: (0, a.jsx)(P, {
              ...
              children: (0, a.jsx)(d.ErrorBoundary, {
                ...
                children: (0, a.jsx)(w, {
                  loading: N,
                  children: (0, a.jsx)(m.HTTPAccessFallbackBoundary, {
                    notFound: f,
                    forbidden: p,
                    unauthorized: y,
    ...
    8938: (e, t, r) => {
      ...
      async function f(e, t, r, l, s, f) {
        ...
        let y = new AbortController(),
          ...
          b = await (0, i.streamToBuffer)(g);
        for (let [e, t] of (p.set('/_tree', b), await Promise.all(m))) p.set(e, t);
        return p;
      }
      async function d({
        shouldAssumePartialData: e,
        ...
        let g = m[0][0],
          ...
          })(e, g, h, b, r, t, a, n, l.ROOT_SEGMENT_KEY, c),
          E = e || (await y(_, a));
    ...
    9521: (e, t, r) => {
      ...
      function g({
        ...
        let g = (0, h.createServerSearchParamsForMetadata)(t, l);
        function _() {
          return O(e, g, a, l, u);
        }
        async function E() {
          try {
            ...
            if (!u && (0, f.isHTTPAccessFallbackError)(t))
              try {
                return await R(e, g, a, l);
              } catch {}
            return null;
          }
        }
        function P() {
          return b(e, g, a, r, l, u);
        }
        async function w() {
          let t,
            n = null;
          try {
            ...
            if (((n = o), !u && (0, f.isHTTPAccessFallbackError)(o)))
              try {
                return {
                  metadata: (t = await v(e, g, a, r, l)),
                  error: n,
                  digest: null == n ? void 0 : n.digest,
                };
              } catch (e) {
                if (((n = e), m && (0, y.isPostpone)(e))) throw e;
              }
            if (m && (0, y.isPostpone)(o)) throw o;
        ...
        return (
          ...
          (S.displayName = d.METADATA_BOUNDARY_NAME),
          {
            ...
            StreamingMetadataOutlet: function () {
              return m ? (0, n.jsx)(p.AsyncMetadataOutlet, { promise: w() }) : null;
            },
          }
        );
      }
