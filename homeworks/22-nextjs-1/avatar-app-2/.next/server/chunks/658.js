  ...
  (exports.modules = {
        ...
        (() => {
          ...
          function a(e, t, r) {
            ...
            if (void 0 === s || s) a || (d += p + '?'), (d += r.endsWith ? '(?=' + c + ')' : '$');
              ...
              var R = e[e.length - 1],
                v = 'string' == typeof R ? p.indexOf(R[R.length - 1]) > -1 : void 0 === R;
              a || (d += '(?:' + p + '(?=' + c + '))?'), v || (d += '(?=' + p + '|' + c + ')');
            }
    ...
    5526: (e, t, r) => {
      ...
      function c(e) {
        ...
        u && (u = s(u));
        let l = r.hash;
        return l && (l = s(l)), { ...r, pathname: n, hostname: u, href: a, hash: l };
      }
      function p(e) {
        let t,
          r,
          ...
          o = c(e),
          { hostname: u, query: l } = o,
          p = o.pathname;
        o.hash && (p = '' + p + o.hash);
        let d = [],
          m = [];
        for (let e of ((0, n.pathToRegexp)(p, m), m)) d.push(e.name);
        if (u) {
          let e = [];
          for (let t of ((0, n.pathToRegexp)(u, e), e)) d.push(t.name);
        }
        let g = (0, n.compile)(p, { validate: !1 });
        for (let [r, i] of (u && (t = (0, n.compile)(u, { validate: !1 })), Object.entries(l)))
          Array.isArray(i)
            ? (l[r] = i.map((t) => f(s(t), e.params)))
            : 'string' == typeof i && (l[r] = f(s(i), e.params));
        let h = Object.keys(e.params).filter((e) => 'nextInternalLocale' !== e);
        if (e.appendParamsToQuery && !h.some((e) => d.includes(e)))
          for (let t of h) t in l || (l[t] = e.params[t]);
        ...
        return (o.query = { ...i, ...o.query }), { newUrl: r, destQuery: l, parsedDestination: o };
      }
    },
    5531: (e, t) => {
      'use strict';
